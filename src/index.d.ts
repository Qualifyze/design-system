// TODO WIP
// This file is just copied to `dist` folder and will use files `index.d.ts` generated by `create-type-definitions.js`
// The order is intentional to make it easy to compare with exports in `index.js`
